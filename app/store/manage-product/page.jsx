...
export default function StoreManageProducts() {
    ...
    const toggleStock = async (productId) => {
        try {
            ...
            // Note: Ensure this URL matches the exact path where you saved your toggle stock route!
            const { data } = await axios.post('/api/store/stock-toggle', { productId }, {
                headers: { Authorization: `Bearer ${token}` }
            })
            
            // ✅ Great job! Updating the state locally is much faster than re-fetching.
